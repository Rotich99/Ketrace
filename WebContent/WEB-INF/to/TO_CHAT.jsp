...
<head>
    ...
    <title>TO: CHAT| Test Officer -KE TRACECOVID</title>
    <!-- google fonts -->
...
<body>
   ...
   <jsp:include page="../pub/_header.jsp"></jsp:include>
    ...
    <!-- hero slider Start -->
    <!--/home-stats-->
    <section class="row container" id="TO_chat">
        <div class="container col-md-6 py-lg-5 py-2">
            <div class="bg-white" id="chatbox">
            	<div class="text-center"><strong class="text-dark text-center mb-2">Chat with ${contextChat.name}</strong></div> <hr class="bg-info">
                <c:forEach items="${chatList }" var="c">
                <div class="row px-3 mb-1">
                    <div class="card col-md-12 px-0 mx-0 border-dark">
                        <div class="card-body">
                            <p class="text-dark">${c.message }</p>
                        </div>
                        <div class=" bg-light text-right pr-2">
                            <small class="font-weight-bold">${c.dateSent }</small>
                        </div>
                    </div>
                </div>
                </c:forEach>
            ...
            <form action="#" method="post" class="form">              
              ...
              <div class="submit-w3l-button text-lg-right">
                  <button class="btn btn-style btn-secondary btn-block" id="btn-send-message"><i class="fa fa-paper-plane fa-lg"></i> Send Chat</button>
              </div>
            </form>
        </div>
    </section>
                    ...
                    <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
                        <div class="grids5-info">
                            ...
                            <div class="blog-info">
                                ...
                                <p class="text-para"> Keep your distance: Stay at least one and a half meters from others, even if they don't appear to be sick, since the people can have virus without having symptoms. </p>
                            </div>
    ...
    <script>
    	...
    	$('#btn-send-message').on('click', function(e){
            ...
            //$(this).addClass('bg-outlinedark');
            $.post('${pageContext.request.contextPath}/to/chat/center?center=${contextChat.centerID}', 
            		{
            		intent: 'postMessage',
            		senderID: '${toContext.nationalID}',
    				recipientID: '${contextChat.centerID}',
    				message: newMsg
            		}, function(data){
            			if(data === "SUCCESS"){
            				...
            				alert("Message not sent, there could be an error. Please retry.");
            			}
            		}
            )
