...
<head>
    ...
    <title>TO_VIEW PROFILE-KE TRACECOVID</title>
    <!-- google fonts -->
...
<body>
   ...
   <jsp:include page="../pub/_header.jsp"></jsp:include>
    ...
    <section class="w3l-homeblock1" id="about-profile">
        <div class="container col-md-6 py-lg-8 py-2">
    <h3 class="text-center bg-info text-white py-4 mb-2"><strong>My Profile</strong></h3>
    <form action="${pageContext.request.contextPath}/register" method="post" class="form form-horizontal" id="to-profile">
      <div class="form-grids">
        <div class="input-group">
            <label for="id number" class="input-group-prepend py-2 px-1 bg-light"><strong>ID NUMBER:</strong></label>
            <input type="number" name="idNumber" id="idNumber" placeholder="" class="form-control" value="${toContext.nationalID }" disabled required="" />
        </div>
        <div class="input-group">
            <label for="first name" class="input-group-prepend py-2 px-1 bg-light"><strong>First Name:</strong></label>
            <input type="text" name="firstName" id="firstName" placeholder="" class="form-control" value="${toContext.firstName }" disabled required="" />
        </div>

        <div class="input-group">
            <label for="last name" class="input-group-prepend py-2 px-1 bg-light"><strong>Last Name:</strong></label>
            <input type="text" name="lastName" id="lastName" placeholder="" class="form-control" value="${toContext.lastName }" disabled required="" />
        </div>
        <div class="input-group">
            <label for="Phone" class="input-group-prepend py-2 px-1 bg-light"><strong>RegDate:</strong></label>
            <input type="text" pattern="[0-9]{10,12}" name="phone" id="phone" placeholder="" class="form-control" value="${toContext.regDate }" disabled required="" />
        </div>

        <div class="input-group">  
            <label for="Email" class="input-group-prepend py-2 px-1 bg-light"><strong>Company:</strong></label>
            <input type="email" name="email" id="email" placeholder="" class="form-control" value="${toContext.company }" disabled required="" />
        </div>
        <div class="input-group">
          <label for="password" class="input-group-prepend py-2 px-1 bg-light"><strong>Password:</strong></label>
          <input type="text" name="password" id="password" placeholder="" class="form-control" value="${toContext.password }"  disabled required="" />   
      </div><br>
