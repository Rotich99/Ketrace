                ...
                <div class="container">
                    <div class="hero-content">
                        ...
                        <div class="cta-btn" data-animation="fadeInUp" data-delay="1s">
                            ...
                            <a href="${pageContext.request.contextPath }/to/medicalcenter#center" class="btn btn-style btn-secondary"><i class="fas fa-phone-alt fa-lg"></i> Contact Medical Center</a>
                            <a href="TO_CHAT.html#TO_chat" class="btn btn-style btn-light"><i class="far fa-comment fa-lg"></i> View Chat</a>
                        </div>
                    </div>
                </div>
