...
<!doctype html>
    ...
    <head>
        ...
        <title>CITIZEN | KE TRACECOVID</title>
        <!-- google fonts -->
...
<section class="w3l-homeblock1" id="profile-section">
 <div class="container col-md-6 py-lg-5 py-2">
    <h3 class="text-center bg-secondary text-white py-4"><strong>My Profile</strong> </h3>
    <form action="${pageContext.request.contextPath}/register" method="post" class="form form-horizontal" id="register-form">
      <div class="form-grids">
        ...
        <div class="input-group">
            ...
            <input type="text" pattern="[0-9]{10,12}" name="phone" id="phone" placeholder="" class="form-control" value="${citizenContext.phone }" disabled required="" />
        </div>
        ...
        <div class="row main-cont-wthree-2 align-items-center">
            <div class="col-lg-6 feature-grid-left pr-lg-5">
                ...
                <p class="text-para"><strong>
                 <li style="list-style-type: circle;"> Clean your hands often.Use soap and water or alcoholbased sanitizer.</li>
