...
@WebServlet(asyncSupported = true, urlPatterns = {"/to/contact/choose"})
public class TOChooseCenter extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public TOChooseCenter() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = this.getServletContext().getRequestDispatcher("/WEB-INF/to/TO_CHOOSE_MEDICAL_CENTER.jsp");
