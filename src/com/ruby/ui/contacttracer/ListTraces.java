...
@WebServlet(asyncSupported = true, urlPatterns = {"/ct/traces"})
public class ListTraces extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			consentList = DBFind.getConsentList(con);
		...
		RequestDispatcher rd = this.getServletContext().getRequestDispatcher("/WEB-INF/ct/CT_LIST_OF_TRACES.jsp");
