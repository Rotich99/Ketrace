...
@WebServlet(asyncSupported = true, urlPatterns = {"/ct/chats"})
public class CTChats extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher rd = this.getServletContext().getRequestDispatcher("/WEB-INF/ct/CT_CHAT.jsp");
